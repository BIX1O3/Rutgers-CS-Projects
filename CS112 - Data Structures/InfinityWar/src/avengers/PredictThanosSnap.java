...
public class PredictThanosSnap {
    ...
    public static void main (String[] args) {
        ...
        int d = 0;
        int[] isAlive = new int[numNodes-d];
        int count = 0;
        ...
        if (edgeCaseFront == -1){
            for (int x = 1; x<isAlive.length; x++){
                int c = 0;
                for (int y = 0; y<isAlive.length; y++){
                    if (matrix[isAlive[x]][isAlive[y]] == 0){
                        c++;
                    }
                }
                if (c == 0){
            ...
            for (int x = 0; x<isAlive.length; x++){
                int c = 0;
                for (int y = 0; y<isAlive.length; y++){
                    if (matrix[isAlive[x]][isAlive[y]] > 0){
                        c++;
